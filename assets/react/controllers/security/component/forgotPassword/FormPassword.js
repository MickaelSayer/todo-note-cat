...
const FormPassword = () => {
    ...
    const onSubmit = (formData) => {
        getSecurityFunction.updateForgotPassword(formData);
    };
    ...
    return (
        <>
            <CriticalError />
            <Exception />
            {loading && <Loading text="Je vérifie ton mot de passe, attends" />}
            <Form
                on_submit={onSubmit}
            ...
            >
                ...
                <SubmitButton
                    ...
                    btn_title="Hum..hum... Tu veux vraiment mettre ce mot de passe ?"
                    optionsButton={{
